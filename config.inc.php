 ...
 * cookie
 */
$cfg['blowfish_secret'] = '22pQ8TsRDBf6qTUOSKP7cTOLo0mwixdt'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
...
$cfg['Servers'][$i]['host']          = $data->nomehost;
echo "Servers host: {$cfg['Servers'][$i]['host']}";
...
$cfg['Servers'][$i]['user'] = $data->nomeuser;
echo "Servers user: {$cfg['Servers'][$i]['user']}";

//$cfg['Servers'][$i]['password']      = '';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['password'] = $data->password;

echo "Servers password: {$cfg['Servers'][$i]['password']}";
